...
import { verifyOtp } from "../../../services/riderServices/riderServices";
//import Swal from "sweetalert2";

import { useSelector } from "react-redux";
import type { RootState } from "../../../redux/store";
import { useDispatch } from "react-redux";
import { clearRegistration } from "../../../redux/Slice/riderSlice";
...
function Otp() {
  ...
  const userEmail = useSelector(
    (state: RootState) => state.riderSlice.registrationData.email
  );
  const verificationToken = useSelector(
    (state: RootState) => state.riderSlice.registrationData.token
  );
